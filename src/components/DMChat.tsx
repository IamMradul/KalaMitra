      ...
      <div className="flex items-center gap-4 px-6 py-4 shrink-0" style={{ background: 'var(--card)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 rounded-xl transition-all hover:bg-red-50 text-[var(--muted)] hover:text-red-500"
            title={t('dm.chat.deleteThread', 'Delete Chat')}
          >
