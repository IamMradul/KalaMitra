              ...
              >
                ...
                <div className="flex items-center gap-2 w-full justify-center">
                  <input
                    ...
                    value={groupGiftUrl}
                    readOnly
                    className="w-2/3 px-4 py-3 border border-[var(--border)] rounded-xl bg-[var(--bg-2)] text-[var(--text)] focus:outline-none focus:ring-2 focus:ring-heritage-blue transition-all"
                  />
                  <button
                      ...
                      <h3 className="text-lg font-serif font-semibold text-[var(--text)] mb-4">{t('groupGiftModal.selectRecipient')}</h3>
                        <div className="mb-4 relative">
                          <input
                            ...
                            className="w-full pl-4 pr-4 py-3 border border-[var(--border)] rounded-xl focus:ring-2 focus:ring-heritage-blue focus:border-transparent bg-[var(--bg-2)] text-[var(--text)] transition-all"
                      ...
                      <h3 className="text-lg font-serif font-semibold text-[var(--text)] mb-6">{t('groupGiftModal.setTargetAmount')}</h3>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-3 border border-[var(--border)] rounded-xl focus:ring-2 focus:ring-heritage-blue focus:border-transparent bg-[var(--bg-2)] text-[var(--text)] font-semibold text-lg transition-all"
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-4 py-3 border border-[var(--border)] rounded-xl focus:ring-2 focus:ring-heritage-blue focus:border-transparent bg-[var(--bg-2)] text-[var(--text)] transition-all resize-none"
                            rows={4}
                    ...
                    <div>
                      ...
                      <div className="mb-4">
                        <input
                          ...
                          value={searchTerm}
                          onChange={(e) => setSearchTerm(e.target.value)}
                          className="w-full px-4 py-3 border border-[var(--border)] rounded-xl focus:ring-2 focus:ring-heritage-blue focus:border-transparent bg-[var(--bg-2)] text-[var(--text)] transition-all"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-3 border border-[var(--border)] rounded-xl bg-[var(--bg-1)] text-[var(--text)] font-semibold focus:ring-2 focus:ring-heritage-blue focus:outline-none transition-all"
